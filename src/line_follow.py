...
def main():
    ...
    ap.add_argument("--invert-steer", action="store_true", default=False, help="flip steering direction")  # No inversion - motors wired opposite
    ap.add_argument("--invert-drive", action="store_true", default=False, help="flip overall forward/back")  # No inversion - motors wired opposite
